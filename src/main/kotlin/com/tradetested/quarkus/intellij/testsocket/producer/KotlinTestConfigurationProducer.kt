...
class KotlinTestConfigurationProducer: RunConfigurationProducer<JUnitConfiguration>(ContinuousTestConfigurationType.instance) {
    ...
    private fun settingsMatchTemplate(configuration: JUnitConfiguration, context: ConfigurationContext): Boolean {
        val predefinedConfiguration = context.getOriginalConfiguration(ContinuousTestConfigurationType.instance)
    ...
    override fun onFirstRun(fromContext: ConfigurationFromContext, context: ConfigurationContext, performRunnable: Runnable) {
        ...
        return object : AbstractTestClassConfigurationProducer(ContinuousTestConfigurationType.instance) {}
